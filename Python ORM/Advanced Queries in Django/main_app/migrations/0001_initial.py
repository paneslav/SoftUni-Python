# Generated by Django 5.0.4 on 2024-08-19 21:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(decimal_places=1, max_digits=2, validators=[main_app.validators.RangeValidator(max_value=99, message='The rating must be between 0.0 and 10.0', min_value=1)])),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
